// // Get API Key
// let STRIPE_PUBLISHABLE_KEY = 'pk_test_51ODWQpHjRTxHUNUSZYRHffKB4qGfbk404Q3vO1CAmXmsOB8cIsiE7pjiiqxPeghsxc1jXrMBcD6tYQVa0gp9gblm00cQb7S181';//document.currentScript.getAttribute('STRIPE_PUBLISHABLE_KEY');

// // Create an instance of the Stripe object and set your publishable API key
// const stripe = Stripe('pk_test_51ODWQpHjRTxHUNUSZYRHffKB4qGfbk404Q3vO1CAmXmsOB8cIsiE7pjiiqxPeghsxc1jXrMBcD6tYQVa0gp9gblm00cQb7S181');

// Get API Key
let STRIPE_PUBLISHABLE_KEY = document.currentScript.getAttribute('STRIPE_PUBLISHABLE_KEY');
let itemName = document.currentScript.getAttribute('itemName');
let itemPrice = document.currentScript.getAttribute('itemPrice');
// Create an instance of the Stripe object and set your publishable API key
...
const paymentFrm = document.querySelector("#msform");
...
async function initialize() {
    const { id, clientSecret } = await fetch("../stripe/payment_init.php", {
        ...
        body: JSON.stringify({ request_type:'create_payment_intent', itemName: itemName, itemPrice: itemPrice }),
    }).then((r) => r.json());
...
async function handleSubmit(e) {
    ...
    const { id, customer_id } = await fetch("../stripe/payment_init.php", {
        ...
        body: JSON.stringify({ request_type:'create_customer', payment_intent_id: payment_intent_id, customerid: customerid }),
    }).then((r) => r.json());
