...
<body>
    <div class="congrats">
        <div class="innercongrats">
            ...
            <h2 style="color: #333; padding-top: 20px;"><b>Money Withdrawal Sucessfull</b></h2>
            ...
            letter-spacing: 0em;
            text-align: center;
            ">The amount will be transacted in your <br> account with in 24 hours, kindly check your<br> email </p>
        </div>
    </div>
      ...
      <div class="main-panel">
        ...
        <div class="container order-withdraw-history">
            ...
            <ul class="tabs">
                ...
                <li class="tab-link" data-tab="tab-2">Withdrawals History</li>
            </ul>
