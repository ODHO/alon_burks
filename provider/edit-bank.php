...
<body class="edit-bankdetails">
    <div class="congrats">
        <div class="innercongrats">
            <h2>Edit Bank Account</h2>
            <form>
                <h3>Cardholder Name:</h3> 
            <select id='selectbank' onchange="show_month()">
                <option selected value=''>Select Bank</option>
                <option value='Bank Name 1'>Bank Name 1</option>
                <option selected value='Bank Name 2'>Bank Name 2</option>
                </select><br><br>
                
                <input type="text" id="fname" name="fname" placeholder="Account Number / IBAN No:"><br><br>
               
                <input type="text" id="fname" name="fname" placeholder="SWIFT / Routing number"><br><br>
