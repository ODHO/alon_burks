...
<body class="serviceprodivder-submit">
    <div class="congrats">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="notify-profile">
            <p>Kindly complete your profile in order setup your shop for customers</p>
          </div>

          <div class="gallery-section-service" style="padding: 40px 0px 30px 0px;">
            <h2 style="padding-bottom: 20px;">Your Past work Images</h2>
            <div class="container">
                <div class="row">
