          ...
          <div class="col-12">
            <div class="chat-area">
              ...
              <?php
                ...
                $sql = "SELECT DISTINCT customer_id, id FROM customer_proposal WHERE provider_id = ?";
                $stmt = $conn->prepare($sql);
                            ...
                            <div class="chat-list tab">
                              ...
                              <a class="tablinks<?php echo $proposalId?> py-3 px-1 taber" onclick="openCity(event, '<?php echo $proposalId?>')" style="display: flex;align-items: center;">
                                  <div style="display: contents;">
                                    <img class="img-fluid profile" src="../customer/<?php echo $profile_picture ?>" alt="user img">
                                  </div>
    ...
    if ($stmt->execute()) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          $proposalId = $row['id'];
            ...
            $customerName = $customerInfo['fullname'];
            $profile_picture = $customerInfo['profile_picture'];
            $messages = getMessages($customerId, $userId, $proposalId);
          ?>
                ...
                <div class="modal-dialog-scrollable">
                    ...
                    <div class="msg-body">
                        <ul>
                            <?php foreach ($messages as $message) : ?>
                                <li class="<?php echo $message['sender'] === 'provider' ? 'repaly' : 'sender'; ?>">
                  ...
                  <div class="send-box">
                    ...
                    <form action="" id="messageForm<?php echo $proposalId; ?>">
                        ...
                        <button type="button" onclick="sendMessage(<?php echo $customerId; ?>, <?php echo $userId; ?>, <?php echo $proposalId; ?>)">
                            <i class="fa fa-paper-plane" aria-hidden="true"></i> Send
                        </button>
                    </form>
                    <script>
                      function sendMessage(customerId, providerId, proposalId) {
                          ...
                          if (messageContent.trim() !== "") {
                              ...
                              xhr.onreadystatechange = function () {
                                  if (xhr.readyState === 4 && xhr.status === 200) {
                                      ...
                                      if (response.success) {
                                          ...
                                          newMessage.className = message.sender === 'provider' ? 'repaly' : 'sender';
                              ...
                              xhr.send(`customerId=${customerId}&providerId=${providerId}&proposalId=${proposalId}&content=${messageContent}`);
                          }
                      }
                    </script>
