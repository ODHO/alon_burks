...
<body class="order-non-verified">
    <div class="congrats">
        <div class="innercongrats">
            <img src="./images/nonverified.png"/>
            <h2 style="color: #333; padding-top: 20px;">You Cannot Change Status Until customer <Br>verifies the pervious Status </h2>
        </div>
    </div>
