...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($postData && isset($postData['proposalId'], $postData['status'], $postData['customerId'], $postData['providerId'], $postData['customerFullName'], $postData['messageContent'], $postData['statusFrom'])) {
