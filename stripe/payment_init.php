...
// Set API key 
// \Stripe\Stripe::setApiKey('sk_test_51ODWQpHjRTxHUNUSBzhAr4uqSdaAM2URfulM6EQTTrVdj0P4ogv8PAw3DgGQqypuTgcVaMZWKQVDNonC1qlDQA6M00Dc6PXSKD'); 
...
if($jsonObj->request_type == 'create_payment_intent'){ 
    ...
    $id = !empty($jsonObj->customerid)?$jsonObj->customerid:''; 
    ...
    $customer_id = !empty($jsonObj->customerid)?$jsonObj->customerid:''; 
